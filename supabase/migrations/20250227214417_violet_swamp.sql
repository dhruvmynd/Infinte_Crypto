/*
  # Fix token transactions table migration

  1. Changes
     - Add IF NOT EXISTS checks for table and indexes
     - Ensure token_transactions table exists with proper structure
     - Create policies for public access
  
  2. Security
     - Enable RLS on token_transactions table
     - Add policies for public access to token_transactions
*/
