...
import { LogOut, User, ChevronDown, Book } from 'lucide-react';
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-gray-800/80 hover:bg-gray-700 rounded-lg text-white transition-colors"
      >
